...
final class StandardXmlFileSystemEntryRenderer implements XmlFileSystemEntryRenderer {
    ...
    private static final String VIEW_NAME_BY_FILE_ENTRY_SOURCE = "xml-by-file-entry-source";
    ...
    private void renderByFileSource(FileSystemEntry fileSystemEntry, Writer writer) {
        ...
        if (sourceModel != null) {
            this.viewRenderer.renderViewWithModel(VIEW_NAME_BY_FILE_ENTRY_SOURCE, sourceModel, writer);
        }
    }
