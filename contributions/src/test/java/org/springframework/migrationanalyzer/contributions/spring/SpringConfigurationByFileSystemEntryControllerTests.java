...
public class SpringConfigurationByFileSystemEntryControllerTests {

    private final SpringConfigurationByFileSystemEntryController controller = new SpringConfigurationByFileSystemEntryController();
    ...
    public void viewNameIsSet() {
        ...
        assertEquals("spring-configuration-by-file", modelAndView.getViewName());
    }
